...
/**
 * Interfaz del servicio para manejar las operaciones relacionadas con las Horas Compensables.
 * Define los métodos que interactúan con la base de datos para realizar consultas específicas.
 */
public interface IHorasCompensablesService {
     ...
     * @param horasCompensablesListadoRequest El objeto que contiene otros filtros adicionales para la búsqueda.
